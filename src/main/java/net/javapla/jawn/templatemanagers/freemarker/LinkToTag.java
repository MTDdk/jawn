...
//            restful = controllerInstance.restful();
            ...
            Map<String, Object> activeweb = (Map<String, Object>) getUnwrapped("activeweb");
...
//            restful = (Boolean) activeweb.get("restful");
        ...
        Map<String, String> queryParams = getQueryParams(params);
        String href = getContextPath();
        href += RouterHelper.generate(controller, action, id, /*restful,*/ queryParams);
    ...
    private Map<String, String> getQueryParams(Map<String, TemplateModel> params) throws TemplateModelException {
