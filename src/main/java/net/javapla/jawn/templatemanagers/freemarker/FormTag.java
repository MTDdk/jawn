...
import net.javapla.jawn.trash.Router;
 ...
 * controller is RESTful or not, see {@link net.javapla.jawn.annotations.RESTful} for more information.
 *
 * <p>
...
//        }
        ...
        String formAction = RouterHelper.generate(controllerPath, action, id, /*restful,*/ new HashMap<>());
