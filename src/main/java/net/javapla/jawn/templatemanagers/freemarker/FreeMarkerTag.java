...
public abstract class FreeMarkerTag implements TemplateDirectiveModel {
    ...
    public void execute(Environment env, @SuppressWarnings("rawtypes") Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
        ...
        try{
            render((Map<String, TemplateModel>)params, sw.toString(), env.getOut());
     ...
     */
    protected abstract void render(Map<String, TemplateModel> params, String body, Writer writer) throws Exception;
     ...
     */
    protected void validateParamsPresence(Map<String, TemplateModel> params, String... names) {
        FreeMarkerUtil.validateParamsPresence(params, names);
    }
     ...
     */
    protected Map<String, TemplateModel> getAllVariables(){
        try{
            @SuppressWarnings("unchecked")
            Iterator<Object> names = FreeMarkerTL.getEnvironment().getKnownVariableNames().iterator();
            Map<String, TemplateModel> vars = new HashMap<>();
            while (names.hasNext()) {
                Object name =names.next();
                vars.put(name.toString(), get(name.toString()));
            }
            return vars;
        }catch(Exception e){
            throw new ViewException(e);
...
//    }
    ...
    /**
     * Returns instance of {@link net.javapla.jawn.AppContext}.
     *
     * @return instance of {@link net.javapla.jawn.AppContext}.
     */
...
//    }
    ...
    /**
     * Returns instance of {@link net.javapla.jawn.Route} to be used for potential conditional logic inside controller filters.
     *
     * @return instance of {@link net.javapla.jawn.Route}
     */
