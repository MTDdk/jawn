...
public class Messages {
     ...
     */
    public static String message(String key, Locale locale, String[] /*Object...*/ params) {
...
//     */
//    public static String message(String key, String[]/*Object...*/ params) {
//        return getMessage(key, Context.getHttpRequest().getLocale(), params);
//    }

    private static String getMessage(String key, Locale locale, String[]/*Object...*/ params){
