...
public class RenderTemplateResponse extends ControllerResponse {
     ...
     */
    protected RenderTemplateResponse(Context context, Map<String, Object> values, String template/*, String format*/){
        super(context);
        ...
        this.format = context.getRouteFormat();
    }
...
//    }
    ...
    void doProcess() {
        try {
            templateManager.merge(values, template, layout, format, context.getRouteLanguage(), context.responseWriter());
        }
